...
set title   "L3 função multMatMat"
set terminal qt 1 title "L3 função multMatMat"
plot '../valores/l3MatMat.dat' using 1:2 title "<com otimização>" with linespoints, \
...
# Gerando figura PNG
set terminal png
set output "l3_MatMat.png"
plot '../valores/l3MatMat.dat' using 1:2 title "<sem otimização>" with linespoints, \
