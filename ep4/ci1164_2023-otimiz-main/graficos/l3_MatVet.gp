...
set title   "L3 função multMatVet"
set terminal qt 1 title "L3 função multMatVet"
plot '../valores/l3MatVet.dat' using 1:2 title "<com otimização>" with linespoints, \
...
# Gerando figura PNG
set terminal png
set output "l3_MatVet.png"
plot '../valores/l3MatVet.dat' using 1:2 title "<sem otimização>" with linespoints, \
